...
<!-- TODO (generated from template — delete this block once done)
  ...
  - [ ] Add a PyPI badge: https://badge.fury.io/py/algebra_worksheets
  - [ ] Add a CI badge from your GitHub Actions build.yml
  - [ ] Fill in docs/overview/README.md with a real project overview
  - [ ] Add real subcommands to algebra_worksheets/cli.py and update scripts/basic_checks.sh
...
```bash
pipx install algebra_worksheets
```

Or with pip:

```bash
pip install algebra_worksheets
```

## Usage

```bash
algebra_worksheets --help
```
